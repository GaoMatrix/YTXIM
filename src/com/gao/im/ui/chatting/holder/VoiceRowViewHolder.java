 ...
 */
package com.gao.im.ui.chatting.holder;
...
import com.gao.im.ui.chatting.ChattingListAdapter;
import com.gao.im.ui.chatting.mode.ViewHolderTag;
import com.gao.im.ui.chatting.mode.ViewHolderTag.TagType;
import com.gao.im.ui.chatting.view.CCPAnimImageView;
...
public class VoiceRowViewHolder extends BaseHolder {
	...
	public static void initVoiceRow(VoiceRowViewHolder holder , ECMessage detail , int position , ChattingActivity activity , boolean receive) {
		...
		ViewHolderTag holderTag = ViewHolderTag.createTag(detail, TagType.TAG_VOICE, position , holder.type , receive);
