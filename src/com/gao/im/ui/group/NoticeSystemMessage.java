 ...
 * @version 4.0
 */
public class NoticeSystemMessage extends ECGroupNotice {
	...
	public NoticeSystemMessage(ECGroupNotice.ECGroupMessageType type) {
		super(type);
	}
	...
	public ContentValues buildContentValues() {
		...
		values.put("notice_id", VoiceUtil.md5(System.currentTimeMillis() + ""));
