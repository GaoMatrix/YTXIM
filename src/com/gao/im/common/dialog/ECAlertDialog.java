 ...
 */
package com.gao.im.common.dialog;
...
public class ECAlertDialog extends Dialog implements View.OnClickListener {
	...
	public static ECAlertDialog buildAlert(Context ctx, int message,int button , DialogInterface.OnClickListener listener) {
		return buildAlert(ctx, ctx.getString(message) , ctx.getString(button), listener);
	}
	
	public static ECAlertDialog buildAlert(Context ctx, int resId, DialogInterface.OnClickListener listener) {
	...
	public static ECAlertDialog buildPositiveAlert(Context ctx , int resId , DialogInterface.OnClickListener listener) {
	 ...
	 * @return
	 */
	public static ECAlertDialog buildPositiveAlert(Context ctx , CharSequence message , DialogInterface.OnClickListener listener) {
		ECAlertDialog dialog = new ECAlertDialog(ctx);
		dialog.setMessage(message);
	 ...
	 * @return
	 */
	public final Button setButton(int id , int resId , DialogInterface.OnClickListener listener) {
	 ...
	 * @return
	 */
	public final Button setButton(int id , CharSequence text , DialogInterface.OnClickListener listener) {
	...
	public final ECAlertDialog setButtonTag(int id , DialogInterface.OnClickListener listener) {
		Button button = mButtons.get(id);
	...
	public void onClick(View v) {
		DialogInterface.OnClickListener clickListener = (OnClickListener) v.getTag();
