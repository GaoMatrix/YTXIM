...
public class FileExplorerActivity extends ECSuperActivity implements
	...
	private void setCurrentTabSelector(int type) {
		mType = type;
		if (type == DIR_SDCARD) {
			mSdcardTab.setTextColor(getResources().getColor(R.color.ccp_green));
			mRootTab.setTextColor(getResources().getColor(R.color.action_bar_tittle_color));
			mRootTabSelector.setVisibility(4);
			mSdcardTabSelector.setVisibility(0);
			return;
		}
		mRootTab.setTextColor(getResources().getColor(R.color.ccp_green));
		mSdcardTab.setTextColor(getResources().getColor(R.color.action_bar_tittle_color));
		mRootTabSelector.setVisibility(0);
		mSdcardTabSelector.setVisibility(4);
	}
