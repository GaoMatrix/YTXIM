...
import com.gao.im.storage.ImgInfoSqlManager.ImgInfoColumn;
...
public class ImgInfo {
	...
	public void setCursor(Cursor cursor) {
		this.id = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.ID));
		this.msgSvrId = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.MSGSVR_ID));
		this.offset = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.OFFSET));
		this.totalLen = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.TOTALLEN));
		this.bigImgPath = cursor.getString(cursor.getColumnIndex(ImgInfoColumn.BIG_IMGPATH));
		this.thumbImgPath = cursor.getString(cursor.getColumnIndex(ImgInfoColumn.THUMBIMG_PATH));
		this.createtime = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.CREATE_TIME));
		this.msglocalid = cursor.getString(cursor.getColumnIndex(ImgInfoColumn.MSG_LOCAL_ID));
		this.status = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.STATUS));
		this.nettimes = cursor.getInt(cursor.getColumnIndex(ImgInfoColumn.NET_TIMES));
	}
