 ...
 */
package com.gao.im.common.view;
...
public class TopBarView extends LinearLayout {
	...
	private void initView() {
		...
		//setBackgroundDrawable(new ColorDrawable(mContext.getResources().getColor(R.color.actionbar_bg_color)));
	...
	private void setMiddleSubTitle(int type , String title , String subTitle , View.OnClickListener onClickListener) {
		...
		setTitle(title);
		if(ECSDKUtils.isNullOrNil(subTitle) || type == 2) {
	...
	public void setTitle(String title) {
		if(ECSDKUtils.isNullOrNil(title)) {
	...
	private void doSetTouchDelegate() {
		...
		post(new Runnable() {
			...
			public void run() {
			    ...
			    middleBtn.setTouchDelegate(new TouchDelegate(rect, TopBarView.this));
			}
		});
	}
