...
import com.gao.im.R;
import com.gao.im.common.utils.DateUtil;
import com.gao.im.common.utils.MediaPlayTools;
import com.gao.im.ui.chatting.holder.BaseHolder;
import com.gao.im.ui.chatting.mode.BaseChattingRow;
import com.gao.im.ui.chatting.mode.ChattingRowType;
import com.gao.im.ui.chatting.mode.DescriptionRxRow;
import com.gao.im.ui.chatting.mode.DescriptionTxRow;
import com.gao.im.ui.chatting.mode.FileRxRow;
import com.gao.im.ui.chatting.mode.FileTxRow;
import com.gao.im.ui.chatting.mode.IChattingRow;
import com.gao.im.ui.chatting.mode.ImageRxRow;
import com.gao.im.ui.chatting.mode.ImageTxRow;
import com.gao.im.ui.chatting.mode.VoiceRxRow;
import com.gao.im.ui.chatting.mode.VoiceTxRow;
...
public class ChattingListAdapter extends BaseAdapter {
	...
	public View getView(int position, View convertView, ViewGroup parent) {
		...
		if(position != 0) {
			...
			if(mShowTimePosition.contains(item.getId())
		...
		BaseChattingRow chattingRow = getBaseChattingRow(messageType, item.getDirection() == Direction.SEND);
	...
	public int getItemViewType(int position) {
		...
		return getBaseChattingRow(ChattingsRowUtils.getChattingMessageType(message.getType()),message.getDirection() == Direction.SEND).getChatViewType();
	}
	...
	public void insertDataArraysAfter(List<ECMessage> data) {
		if(data != null) {
			for(int i = data.size() -1 ; i >=0 ; i --) {
				insertData(data.get(i) , getCount() - 1);
