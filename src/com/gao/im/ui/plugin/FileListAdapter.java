...
import com.gao.im.R;
import com.gao.im.common.utils.CnToCharUntil;
...
public class FileListAdapter extends BaseAdapter {
	...
	public void setFiles(File parent ,File sub) {
		...
		if(mFiles.length > 0) {
			ArrayList<FileItem> spellDirectoty = new ArrayList<FileListAdapter.FileItem>();
			ArrayList<FileItem> spellFile = new ArrayList<FileListAdapter.FileItem>();
